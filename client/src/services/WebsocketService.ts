...
type ServerEvent = "heartbeat" | "countdown" | "generated_spell" | "score";
type ClientEvent = "ready" | "generate:spell" | "invoke";
...
type ClientMessage = ReadyMessage | GenerateSpellMessage | InvokeMessage;
